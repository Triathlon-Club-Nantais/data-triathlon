...
- [X] T058 [P] [US13] Test vitest pour `ValidationBacklogChart` (état vide sans résolution post-migration) dans `frontend/components/charts/ValidationBacklogChart.test.tsx`
...
- [X] T065 [US13] Ajouter `getValidationQueueHistory` dans `frontend/lib/api/client.ts`
- [X] T066 [US13] Créer `ValidationBacklogChart.tsx` et l'intégrer sur `benevoles/page.tsx`
